...
#ifndef OPTIMIZERRCPP
#define OPTIMIZERRCPP
...
private:
    ...
    settingsPSO_a2a setpso;
    time_state_information_a2a model;
    double best_particle_objective_value;
    std::vector<double> best_particle_param_values;
    double (*fctptr)(std::vector<double> &param_combi_start, OS2 ode_system, time_state_information_a2a &solv_param_struc);
    OS2 odes; //Rcpp::XPtr<OS2> odes;
public:
    Optimizer_a2a (
